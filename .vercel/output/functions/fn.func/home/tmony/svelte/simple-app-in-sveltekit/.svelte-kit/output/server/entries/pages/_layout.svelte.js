...
const css = {
  code: ".danger{--toastBackground:#4299e1;--toastBarBackground:#2b6cb0}.success{--toastBackground:rgba(245, 208, 254, 0.95);--toastColor:#424242;--toastBarBackground:fuchsia}",
  map: null
};
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `${slots.default ? slots.default({}) : ``} ${validate_component(SvelteToast, "SvelteToast").$$render($$result, { options }, {}, {})}`;
});
export {
  Layout as default
};
